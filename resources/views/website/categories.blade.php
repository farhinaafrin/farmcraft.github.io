                              ...
                              <div class="bd-product__check">
                                ...
                                <ul>
                                    ...
                                    <li>
                                       ...
                                       <label class="check-label" for="s-01">{{ $category->name }}e</label>
                                    </li>
                                    @endforeach
                                 </ul>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="bd-trending__item text-center mb-30">
                                             <div class="bd-trending__product-thumb border-5">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-01.png"
                                                      alt="product-img"></a>
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-02.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__action">
                                                   <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                      data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-03.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__tag">
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-04.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__tag">
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-05.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__tag">
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-06.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__action">
                                                   <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                      data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                       ...
                                       <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                          <div class="bd-trending__item mb-45 text-center">
                                             <div class="bd-trending__product-thumb">
                                                <a href="product-details.html"><img
                                                      src="assets/img/trending/product/product-07.png"
                                                      alt="product-img"></a>
                                                <div class="bd-product__tag">
